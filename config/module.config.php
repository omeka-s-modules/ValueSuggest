...
return [
    ...
    'data_types' => [
        'factories' => [
            ...
            'valuesuggest:ndeterms:aHR0cHM6Ly9kcnVpZC5kYXRhbGVnZW5kLm5ldC9BZGFtTmV0L0dlb2dyYXBoeS9zcGFycWwjc3RyZWV0cw==' => \ValueSuggest\Service\NdeTermsDataTypeFactory::class,
            'valuesuggest:ndeterms:aHR0cHM6Ly9kYXRhLmN1bHR1cmVlbGVyZmdvZWQubmwvUG9vbFBhcnR5L3NwYXJxbC90ZXJtL2lkL2Ficg==' => \ValueSuggest\Service\NdeTermsDataTypeFactory::class,
            'valuesuggest:ndeterms:aHR0cDovL3ZvY2FiLmdldHR5LmVkdS9hYXQvc3BhcnFs' => \ValueSuggest\Service\NdeTermsDataTypeFactory::class,
            'valuesuggest:ndeterms:aHR0cDovL2RhdGEuYmlibGlvdGhla2VuLm5sL3RoZXMvYnJpbmttYW4vc3BhcnFs' => \ValueSuggest\Service\NdeTermsDataTypeFactory::class,
            'valuesuggest:ndeterms:aHR0cHM6Ly9kYXRhLmN1bHR1cmVlbGVyZmdvZWQubmwvUG9vbFBhcnR5L3NwYXJxbC90ZXJtL2lkL2NodA==' => \ValueSuggest\Service\NdeTermsDataTypeFactory::class,
            'valuesuggest:ndeterms:aHR0cDovL3B1YmxpY2F0aW9ucy5ldXJvcGEuZXUvd2ViYXBpL3JkZi9zcGFycWwjZXVyb3ZvYw==' => \ValueSuggest\Service\NdeTermsDataTypeFactory::class,
            'valuesuggest:ndeterms:aHR0cHM6Ly9kYXRhLmJlZWxkZW5nZWx1aWQubmwvaWQvZGF0YWRvd25sb2FkLzAwMjc=' => \ValueSuggest\Service\NdeTermsDataTypeFactory::class,
            'valuesuggest:ndeterms:aHR0cHM6Ly9kYXRhLmJlZWxkZW5nZWx1aWQubmwvaWQvZGF0YWRvd25sb2FkLzAwMjg=' => \ValueSuggest\Service\NdeTermsDataTypeFactory::class,
            'valuesuggest:ndeterms:aHR0cHM6Ly9kYXRhLmJlZWxkZW5nZWx1aWQubmwvaWQvZGF0YWRvd25sb2FkLzAwMjk=' => \ValueSuggest\Service\NdeTermsDataTypeFactory::class,
            'valuesuggest:ndeterms:aHR0cHM6Ly9kYXRhLmJlZWxkZW5nZWx1aWQubmwvaWQvZGF0YWRvd25sb2FkLzAwMzA=' => \ValueSuggest\Service\NdeTermsDataTypeFactory::class,
            'valuesuggest:ndeterms:aHR0cHM6Ly9kYXRhLmJlZWxkZW5nZWx1aWQubmwvaWQvZGF0YWRvd25sb2FkLzAwMzE=' => \ValueSuggest\Service\NdeTermsDataTypeFactory::class,
            'valuesuggest:ndeterms:aHR0cHM6Ly9kYXRhLmJlZWxkZW5nZWx1aWQubmwvaWQvZGF0YWRvd25sb2FkLzAwMzI=' => \ValueSuggest\Service\NdeTermsDataTypeFactory::class,
            'valuesuggest:ndeterms:aHR0cHM6Ly9kYXRhLmJlZWxkZW5nZWx1aWQubmwvaWQvZGF0YWRvd25sb2FkLzAwMjY=' => \ValueSuggest\Service\NdeTermsDataTypeFactory::class,
            'valuesuggest:ndeterms:aHR0cHM6Ly9kYXRhLm11emlla3dlYi5ubC9NdXppZWt3ZWJPcmdhbml6YXRpb24vTXV6aWVrd2ViL3NwYXJxbC9NdXppZWt3ZWIjbXctZ2VucmVzc3Rpamxlbg==' => \ValueSuggest\Service\NdeTermsDataTypeFactory::class,
            'valuesuggest:ndeterms:aHR0cHM6Ly9kYXRhLm11emlla3dlYi5ubC9NdXppZWt3ZWJPcmdhbml6YXRpb24vTXV6aWVrd2ViL3NwYXJxbC9NdXppZWt3ZWIjbXctcGVyc29uZW5ncm9lcGVu' => \ValueSuggest\Service\NdeTermsDataTypeFactory::class,
            'valuesuggest:ndeterms:aHR0cHM6Ly9kYXRhLm11emlla3NjaGF0dGVuLm5sL3NwYXJxbC8jb25kZXJ3ZXJwZW4=' => \ValueSuggest\Service\NdeTermsDataTypeFactory::class,
            'valuesuggest:ndeterms:aHR0cHM6Ly9kYXRhLm11emlla3NjaGF0dGVuLm5sL3NwYXJxbC8jcGVyc29uZW4=' => \ValueSuggest\Service\NdeTermsDataTypeFactory::class,
            'valuesuggest:ndeterms:aHR0cDovL2RhdGEuYmlibGlvdGhla2VuLm5sL3RoZXNwL3NwYXJxbA==' => \ValueSuggest\Service\NdeTermsDataTypeFactory::class,
            'valuesuggest:ndeterms:aHR0cHM6Ly9kYXRhLm5ldHdlcmtkaWdpdGFhbGVyZmdvZWQubmwvcmtkL3JrZGFydGlzdHMvc3BhcnFs' => \ValueSuggest\Service\NdeTermsDataTypeFactory::class,
            'valuesuggest:ndeterms:aHR0cDovL2RhdGEuYmlibGlvdGhla2VuLm5sL3RoZXMvZHJ1a2tlcnMvc3BhcnFs' => \ValueSuggest\Service\NdeTermsDataTypeFactory::class,
            'valuesuggest:ndeterms:aHR0cHM6Ly9kYXRhLm5ldHdlcmtkaWdpdGFhbGVyZmdvZWQubmwvTk1WVy90aGVzYXVydXMvc3BhcnFs' => \ValueSuggest\Service\NdeTermsDataTypeFactory::class,
            'valuesuggest:ndeterms:aHR0cHM6Ly9xdWVyeS53aWtpZGF0YS5vcmcvc3BhcnFsI2VudGl0aWVzLWFsbA==' => \ValueSuggest\Service\NdeTermsDataTypeFactory::class,
            'valuesuggest:ndeterms:aHR0cHM6Ly9xdWVyeS53aWtpZGF0YS5vcmcvc3BhcnFsI2VudGl0aWVzLXBlcnNvbnM=' => \ValueSuggest\Service\NdeTermsDataTypeFactory::class,
            'valuesuggest:ndeterms:aHR0cHM6Ly9xdWVyeS53aWtpZGF0YS5vcmcvc3BhcnFsI2VudGl0aWVzLXBsYWNlcw==' => \ValueSuggest\Service\NdeTermsDataTypeFactory::class,
            'valuesuggest:ndeterms:aHR0cHM6Ly9xdWVyeS53aWtpZGF0YS5vcmcvc3BhcnFsI2VudGl0aWVzLXN0cmVldHM=' => \ValueSuggest\Service\NdeTermsDataTypeFactory::class,
            'valuesuggest:ndeterms:aHR0cHM6Ly9kYXRhLm5pb2QubmwvUG9vbFBhcnR5L3NwYXJxbC9XTzJfVGhlc2F1cnVz' => \ValueSuggest\Service\NdeTermsDataTypeFactory::class,
