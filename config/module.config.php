...
return [
    ...
    'data_types' => [
        'factories' => [
            ...
            'valuesuggestall:mc:T513' => \ValueSuggest\Service\McDataTypeFactory::class,
            'valuesuggestall:mc:T51' => \ValueSuggest\Service\McDataTypeFactory::class,
            'valuesuggestall:mc:T115' => \ValueSuggest\Service\McDataTypeFactory::class,
            'valuesuggestall:mc:T505' => \ValueSuggest\Service\McDataTypeFactory::class,
            'valuesuggestall:mc:T506' => \ValueSuggest\Service\McDataTypeFactory::class,
            'valuesuggestall:mc:T520' => \ValueSuggest\Service\McDataTypeFactory::class,
            'valuesuggestall:mc:T84' => \ValueSuggest\Service\McDataTypeFactory::class,
            'valuesuggestall:mc:T515' => \ValueSuggest\Service\McDataTypeFactory::class,
            'valuesuggestall:mc:T521' => \ValueSuggest\Service\McDataTypeFactory::class,
            'valuesuggestall:mc:T523' => \ValueSuggest\Service\McDataTypeFactory::class,
            'valuesuggestall:mc:T507' => \ValueSuggest\Service\McDataTypeFactory::class,
            'valuesuggestall:mc:T516' => \ValueSuggest\Service\McDataTypeFactory::class,
            'valuesuggestall:mc:T86' => \ValueSuggest\Service\McDataTypeFactory::class,
            'valuesuggestall:mc:T517' => \ValueSuggest\Service\McDataTypeFactory::class,
            'valuesuggestall:mc:T93' => \ValueSuggest\Service\McDataTypeFactory::class,
        ],
    ],
    'router' => [
        'routes' => [
